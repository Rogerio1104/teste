...
public class PessoaRepository {
    ...
    public List<Pessoa> buscaPorId(Long id) throws SQLException, ClassNotFoundException {
        ...
        PreparedStatement stmt = connection.prepareStatement("select * pessoa WHERE id = ?");
        stmt.setLong(1, id);
        ResultSet resultSet = stmt.executeQuery();
    ...
    public void update(Pessoa pessoa) throws SQLException, ClassNotFoundException {
        Connection connection = getConnection();
        PreparedStatement stmt = connection.prepareStatement("update pessoa "+ "SET nome = ?, documento = ? WHERE id = ?");
